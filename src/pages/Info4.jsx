  ...
  return (
    <div className="info-page">
      ...
      <section className="main-info">
        <h2>Hoy - <span>Sahir</span></h2>
        <div className="info-content">
          <img
            src="https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/82/13/7f/82137f9b-1ee7-172d-769e-b3c370225e79/198588017104.jpg/1200x1200bb.jpg"
            alt="Hoy - Sahir"
            className="info-image"
          />
          <p>
          Nuevo junte por parte de Sahir, Hades66 y Anubis que rompe con todo, denostrando el verdadero potencial de la nueva generacón de Puerto Rico.
          </p>
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <ul className="player-options">
              <li><a href="https://open.spotify.com/intl-es/track/18RqhX8fEWsypvhXs85OpF" target="_blank" rel="noopener noreferrer">Spotify</a></li>
              <li><a href="https://www.youtube.com/watch?v=7xsCop3cf14" target="_blank" rel="noopener noreferrer">YouTube</a></li>
              <li><a href="https://music.apple.com/es/song/hoy/1744404203" target="_blank" rel="noopener noreferrer">Apple Music</a></li>
            </ul>
